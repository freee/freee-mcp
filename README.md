...
freee会計、人事労務、請求書、工数管理、販売、IT管理、業務委託管理、サイン（電子契約）を AI Agent から操作できるようにする freee 公式の MCP サーバーと Agent Skills です。
...
- 複数 API 対応: 会計・人事労務・請求書・工数管理・販売・IT管理・業務委託管理の7つの freee API をサポート
