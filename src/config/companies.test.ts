...
describe('companies', () => {
  ...
  describe('setCurrentCompany', () => {
    ...
    it.each([
      ...
      'constructor',
      'prototype',
    ])('should reject reserved key %s to prevent prototype pollution', async (reserved) => {
      mockFs.readFile.mockResolvedValue(JSON.stringify(validConfig));
      mockFs.mkdir.mockResolvedValue(undefined);
      mockFs.writeFile.mockResolvedValue(undefined);
  ...
  describe('getCompanyInfo', () => {
    ...
    it.each([
      ...
      'constructor',
      'prototype',
    ])('should reject reserved key %s instead of leaking prototype values', async (reserved) => {
      mockFs.readFile.mockResolvedValue(JSON.stringify(validConfig));
